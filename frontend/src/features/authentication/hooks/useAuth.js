...
var useAuth = function () {
    ...
    var login = (0, react_1.useCallback)(function (credentials) { return __awaiter(void 0, void 0, void 0, function () {
        var user, error_1, errorMessage_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    errorMessage_1 = error_1 instanceof Error ? error_1.message : 'Login failed';
    ...
    var register = (0, react_1.useCallback)(function (data) { return __awaiter(void 0, void 0, void 0, function () {
        var user, error_2, errorMessage_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setState(function (prev) { return (__assign(__assign({}, prev), { isLoading: true, error: null })); });
                ...
                case 3:
                    error_2 = _a.sent();
                    errorMessage_2 = error_2 instanceof Error ? error_2.message : 'Registration failed';
    ...
    return __assign(__assign({}, state), { login: login, register: register, logout: logout, clearError: clearError });
};
